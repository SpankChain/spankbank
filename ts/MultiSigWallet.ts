...
export class MultiSigWallet extends TC.TypeChainContract {
  ...
  public get transactionCount(): Promise<BigNumber> {
    return TC.promisify(this.rawWeb3Contract.transactionCount, []);
  }

  public get MAX_OWNER_COUNT(): Promise<BigNumber> {
    return TC.promisify(this.rawWeb3Contract.MAX_OWNER_COUNT, []);
  }

  public get required(): Promise<BigNumber> {
    return TC.promisify(this.rawWeb3Contract.required, []);
  }

  public get getOwners(): Promise<string[]> {
    return TC.promisify(this.rawWeb3Contract.getOwners, []);
  }

  public owners(arg0: BigNumber | number): Promise<string> {
    return TC.promisify(this.rawWeb3Contract.owners, [arg0.toString()]);
  }

  public isOwner(arg0: BigNumber | string): Promise<boolean> {
    return TC.promisify(this.rawWeb3Contract.isOwner, [arg0.toString()]);
  }
  ...
  public confirmations(
    ...
    return TC.promisify(this.rawWeb3Contract.confirmations, [
      arg0.toString(),
      arg1.toString()
    ]);
  }
  ...
  public transactions(
    ...
    return TC.promisify(this.rawWeb3Contract.transactions, [arg0.toString()]);
  }

  public isConfirmed(transactionId: BigNumber | number): Promise<boolean> {
    return TC.promisify(this.rawWeb3Contract.isConfirmed, [
  ...
  public getConfirmationCount(
    ...
    return TC.promisify(this.rawWeb3Contract.getConfirmationCount, [
      transactionId.toString()
    ]);
  }
  ...
  public getTransactionCount(
    ...
    return TC.promisify(this.rawWeb3Contract.getTransactionCount, [
      pending.toString(),
      executed.toString()
    ]);
  }
  ...
  public getConfirmations(
    ...
    return TC.promisify(this.rawWeb3Contract.getConfirmations, [
      transactionId.toString()
    ]);
  }
  ...
  public getTransactionIds(
    ...
    return TC.promisify(this.rawWeb3Contract.getTransactionIds, [
      from.toString(),
      to.toString(),
      pending.toString(),
      executed.toString()
  ...
  public addOwnerTx(
    ...
    return new TC.DeferredTransactionWrapper<TC.ITxParams>(this, "addOwner", [
      owner.toString()
    ]);
  }
  ...
  public replaceOwnerTx(
    ...
    return new TC.DeferredTransactionWrapper<TC.ITxParams>(
      this,
      "replaceOwner",
      [owner.toString(), newOwner.toString()]
    );
  }
  ...
  public RequirementChangeEvent(eventFilter: {}): TC.DeferredEventWrapper<
    { required: BigNumber | number },
    {}
  > {
    return new TC.DeferredEventWrapper<{ required: BigNumber | number }, {}>(
      this,
      "RequirementChange",
      eventFilter
    );

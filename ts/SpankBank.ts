...
export class SpankBank extends TypeChainContract {
  ...
  public get closingVotes(): Promise<BigNumber> {
    return promisify(this.rawWeb3Contract.closingVotes, []);
  }
  ...
  public get isClosed(): Promise<boolean> {
    return promisify(this.rawWeb3Contract.isClosed, []);
  }
  ...
  public getVote(
    ...
    return promisify(this.rawWeb3Contract.getVote, [
      stakerAddress.toString(),
      period.toString()
    ]);
  }
  public getPeriod(
    ...
    return promisify(this.rawWeb3Contract.getPeriod, [period.toString()]);
  }
  public getStaker(
    stakerAddress: BigNumber | string
  ): Promise<[BigNumber, BigNumber, BigNumber, string, string]> {
    return promisify(this.rawWeb3Contract.getStaker, [
      stakerAddress.toString()
    ]);
  }
  public getStakerFromDelegateKey(
    ...
    return promisify(this.rawWeb3Contract.getStakerFromDelegateKey, [
  ...
  public voteToCloseTx(): DeferredTransactionWrapper<ITxParams> {
    return new DeferredTransactionWrapper<ITxParams>(this, "voteToClose", []);
  }

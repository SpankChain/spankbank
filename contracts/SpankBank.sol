...
contract SpankBank {
    ...
    **************************************/
    ...
    function stake(uint256 spankAmount, uint256 stakePeriods) active public {
        ...
        stakers[msg.sender] = Staker(spankAmount, currentPeriod + 1, currentPeriod + stakePeriods, false);
    ...
    function splitStake(address newAddress, uint256 spankAmount) public {
        ...
        stakers[newAddress] = Staker(spankAmount, staker.startingPeriod, staker.endingPeriod, false);
    }
    ...
    function voteToUnwind() public {
        ...
        if (unwindPeriod != currentPeriod) {
            ...
            unwindVotes = 0;
            staker.votedToUnwind = false;
        }
        
        require (staker.votedToUnwind == false);
        staker.votedToUnwind = true;
        SafeMath.add(unwindVotes, staker.spankStaked);
